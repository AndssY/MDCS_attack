...
from DRAttacker import Attacker, ImageAttacker, TextAttacker
...
if __name__ == '__main__':
    ...
    parser.add_argument('--attack', type=str, default='sa_aet')
    args = parser.parse_args()

    config = yaml.load(open(args.config, 'r'), Loader=yaml.Loader)
    if args.attack == 'sga':
        from SGAttacker import Attacker, ImageAttacker, TextAttacker
    elif args.attack == 'mdcssga':
        from SGAttacker_plus import Attacker, ImageAttacker, TextAttacker
    elif args.attack == 'dra':
        from DRAttacker import Attacker, ImageAttacker, TextAttacker
    elif args.attack == 'mdcsdra':
        from DRAttacker_plus import Attacker, ImageAttacker, TextAttacker
    main(args, config)    
